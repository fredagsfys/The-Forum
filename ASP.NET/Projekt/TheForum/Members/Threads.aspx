...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView ID="ThreadListView" runat="server" 
        DataSourceID="ThreadDetailsObjectDataSource" DataKeyNames="ThreadId">
        <EditItemTemplate>
             <div class="span12 well">
                ...
                <div class="span10">
	                <h2>
                        ...
                        <asp:TextBox ID="ThreadNameTextBox" runat="server" Text='<%# Bind("ThreadName") %>' />
	                </h2>
	            </div>
                <div class="span10">
                    <p>
                        ...
                        <asp:TextBox ID="ThreadContentTextBox" runat="server" Text='<%# Bind("ThreadContent") %>' TextMode="MultiLine" CssClass="span11" Rows="8" />
                    </p>    
                </div>
	            <div class="span11">
	                    <hr>
